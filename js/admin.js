...
async function initAdmin() {
    ...
    if (currentUser.role === 'tester') {
        ...
        var ordersTab = document.querySelector('.admin-tab[data-admin-tab="orders"]');
        ...
        var ordersPane = document.querySelector('.admin-tab-pane[data-pane="orders"]');
        if (ordersPane) ordersPane.classList.remove('active');
